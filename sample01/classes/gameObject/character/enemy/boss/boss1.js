class Boss1 extends Boss {
  ...
  constructor(width, height) {
    ...
    this.setHitDistance(150 / 2);

    this.setPhaseHP();

    // 弾幕の発射を開始
    // this.#scheduleId1 = this.addSchedule(this.#danmaku2_1.bind(this), 8, true);
    // this.#scheduleId2 = this.addSchedule(this.#danmaku2_2.bind(this), 10, true);  
  ...
  #danmaku2_2() {
    ...
    // 角度
    const rotate = (Math.atan2(vectorY, vectorX) * 180) / Math.PI;
